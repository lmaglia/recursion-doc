			...
			\Procedure{tail-fibonacci}{$p,m$}
				...
				\Else
					...
					\Else
						...
						\Else
							\State\Return{\Call{tail-fibonacci}{$pop(p)$, \Call{nested-fibonacci}{$top(p)-2$,\Call{nested-fibonacci}{$top(p)-1,m$}}}}
						\EndIf
					\EndIf
				\EndIf
			\EndProcedure
...
\begin{frame}
	...
	\begin{equation}
		\tiny
		\begin{split}
			tail-fibonacci(pop(p),nested-fibonacci(top(p)-2,nested-fibonacci(top(p)-1,m))) \\ =
			tail-fibonacci(push(top(p)-2,pop(p)),nested-fibonacci(top(p)-1,m))\\ =
			tail-fibonacci(push(top(p)-1,push(top(p)-2,pop(p))),m)
		\end{split}
	\end{equation}
\end{frame}
\begin{frame}
				...
				\Else
					...
					\Else
						\If{$top(p) = 1$}
							\State\Return{\Call{tail-fibonacci}{$pop(p),m+1$}}
						\Else
							\State\Return{\Call{tail-fibonacci}{$push(top(p)-1,push(top(p)-2,pop(p)))$, $m$}}
						\EndIf
					\EndIf
				\EndIf
			\EndProcedure
...
\begin{frame}
	...
	\begin{block}{Note}
	This section is to show you some more examples. These are a little more complex, and they don't follow the same steps as previous ones.
	\end{block}
\end{frame}
\subsection{Binary Tree Traversal - \textit{inorder}}
\begin{frame}
...
\begin{frame}
	\frametitle{Some other examples}
	\begin{block}{ggInorder - unfolding gInorder}
		\begin{algorithmic}[1]
			\tiny
			\Procedure{gg-inorder}{$p,t$}
				\If {$isEmpty(p)$}
				...
				\Else
					\If {$isNil(top(p)_0)$}
						\State \Return \Call{gg-inorder}{$pop(p), top(p)_1++[]++t$}
					\Else
						\State \Return \Call{gg-inorder}{$pop(p),$\Call{g-inorder}{$left(top(p)_0),top(p)_1,$\Call{g-inorder}{$right(top(p)_0), [root(top(p)_0)],t$} } }
					\EndIf
				\EndIf
			\EndProcedure
		\end{algorithmic}
...
\begin{frame}
	\frametitle{Some other examples}
	We only have \textbf{fold} line number $8$. We will do this in two \textbf{folds}
	\begin{algorithmic}[1]
		\tiny
		\State \Return{\Call{gg-inorder}{$push(<left(top(p)_0),top(p)_1>,pop(p)),$\Call{g-inorder}{$right(top(p)_0, [root(top(p)_0)]),t$}}}
	\end{algorithmic}
	and the second one is 
	\begin{algorithmic}[1]
		\tiny
		\State \Return{\Call{gg-inorder}{$push(<right(top(p)_0),[root(top(p)_0)]>,push(<left(top(p)_0),top(p)_1>,pop(p))),t$}}
	\end{algorithmic}
\end{frame}
\begin{frame}
	\frametitle{Some othe examples}
	\begin{block}{ggInorder - folding }
		\begin{algorithmic}[1]
			\tiny
			\Procedure{gg-inorder}{$p,t$}
				\If {$isEmpty(p)$}
...
\begin{frame}
	...
	\begin{block}{Iterative gg-inorder}
		\begin{algorithmic}[1]
			\Procedure{iterative-gg-inorder}{$p,t$}
				\While {$\neg isEmpty(p)$}
					\State $r \gets top(p)$
					\State $p \gets pop(p)$
					\If {$isNill(r_0)$}
...
\begin{frame}
	...
	\begin{block}{interative-g-inorder}
		\begin{algorithmic}[1]
			\Procedure{iterative-g-inorder}{$a,s,t$}
				\State \Return{\Call{iterative-gg-inorder}{$push(<a,s>,[]),t$}}
			\EndProcedure
		\end{algorithmic}
	\end{block}
	\begin{block}{interative-inorder}
		\begin{algorithmic}[1]
			\Procedure{iterative-inorder}{$a$}
				\State \Return{\Call{iterative-g-inorder}{$a,[],[]$}}
			\EndProcedure
		\end{algorithmic}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Copy a N-Ary Tree}
		\begin{algorithmic}[1]
			\Procedure{copy}{$a$}
				\State \Return{$tree(root(a), copyChildren(children(a)))$}
			\EndProcedure
		\end{algorithmic}
	\end{block}
	Where
	\begin{block}{Copy Children}
		\begin{algorithmic}[1]
			\Procedure{copyChildren}{$s$}
				\If {$isEmpty(s)$}
					\State \Return{$[]$}
				\Else
					\State \Return{\Call{copy}{$first(s)$} $+$ \Call{copyChildren}{$tail(s)$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
...
\begin{frame}
	...
	\begin{block}{Tail $copyChildren$}
		\begin{algorithmic}[1]
			\Procedure{g-CopyChildren}{$s,t$}
				\State \Return{$t \&$ \Call{copyChildren}{$s$}}
			\EndProcedure
		\end{algorithmic}
	\end{block}
		...
		\begin{algorithmic}[1]
			\Procedure{g-CopyChildren}{$s,t$}
				\If {$isEmpty(s)$}
					\State \Return{$t \& []$}
				\Else
					\State \Return{$t \& $ \Call{copy}{$first(s)$} $+$ \Call{copyChildren}{$tail(s)$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
		...
		\begin{algorithmic}[1]
			\Procedure{g-CopyChildren}{$s,t$}
				\If {$isEmpty(s)$}
					\State \Return{$t \& []$}
				\Else
					\State \Return{\Call{g-copyChildren}{$tail(s),t+$ \Call{copy}{$first(s)$}}} 
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
...
\begin{frame}
	...
	\begin{block}{gCopy}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{g-copy}{$a, p$}
				\If {$isEmpty(p)$}
					\State \Return{$a$}
				\Else
					\If {$isEmpty(top(p)_1)$}
						\If {$isNull(a)$}
							\State \Return{\Call{g-copy}{$tree(root(top(p)_0), top(p)_2),pop(p))$}}
						\Else
							\State \Return{\Call{g-copy}{$tree(root(top(p)_0),top(p)_2 + a),pop(p)$}}
						\EndIf
					\Else
						\State \Return{\Call{g-copy}{\Call{copy}{$first(top(p)_1)$}$, push(<top(p)_0, tail(top(p)_1), top(p)_2 + a>,pop(p))$}}
					\EndIf
				\EndIf
			\EndProcedure
		\end{algorithmic}
...
\begin{frame}
	...
	\begin{block}{gg-copy}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{gg-copy}{$a,t,valid,p$}
				\If {$\neg valid$} 
					\State \Return{\Call{g-copy}{\Call{copy}{$a$}$,p$}}
				\Else
					\State \Return{\Call{g-copy}{$t,p$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
	...
	\begin{algorithmic}[1]
		\tiny
		\State \Call{g-copy}{\Call{copy}{$a$} $, p$} $=$ \Call{g-copy}{$tree(root(a),$\Call{copyChildren}{$children(a)$} $),p$}
	\end{algorithmic}
	By using $g-copy$ line number $7$, we can \textbf{fold} it in this manner
	\begin{algorithmic}[1]
		\tiny
		\State  \Call{g-copy}{$tree(root(a),$\Call{copyChildren}{$children(a)$} $),p$} $=$ \Call{g-copy}{$null, push(<a, [],$\Call{copyChildren}{$children(a)$} $>,p)$}
	\end{algorithmic}
	Let's \textbf{unfold} $copyChildren$
\end{frame}
\begin{frame}
	\frametitle{Copy N-Ary Tree}
	 \begin{algorithmic}[1]
		 \tiny
		 \If {$isEmpty(children(a))$}
		 	\State \Call{g-copy}{$null, push(<a, [],[]>,p)$}
		 \Else
			\State \Call{g-copy}{$null,push(<a,[],$\Call{copy}{$first(children(a))$} $+$ \Call{copyChildren}{$tail(children(a))$}$>,p)$}
		 \EndIf
	 \end{algorithmic}
	 Converting line $4$ is tricky and we should probe it. To convert this line we will use  $gCopy$ line $12$. Such equation will be used until $top(p)_1$ is empty. When it is, $top(p)_2$ will contain the copy of all the children of the tree but for the last one. The last one will be added by the equation defined in $g-copy$ line $9$, which will be the equation used when $top(p)_1$ is empty. Thus..
	 \begin{algorithmic}[1]
		 \tiny
		 \If {$isEmpty(children(a))$}
		 	\State \Call{g-copy}{$null, push(<a, [],[]>,p)$}
		 \Else
			\State \Call{g-copy}{\Call{copy}{$first(children(a))$}$,push(<a,tail(children(a)),[]>,p)$}
		 \EndIf
	 \end{algorithmic}
...
\begin{frame}
	\frametitle{Copy N Ary Tree}
	Let's \textbf{fold} them
	For line $2$, we will use $gg-copy$ line $5$, and for line $4$ we will use $gg-copy$ line $3$
	\begin{block}{folding..}
	 	\begin{algorithmic}[1]
		 	\tiny
			 \If {$isEmpty(children(a))$}
			 	\State \Call{gg-copy}{$null,null, true, push(<a, [],[]>,p)$}
			 \Else
				\State \Call{gg-copy}{$first(children(a)),t, false, push(<a,tail(children(a)),[]>,p)$}
			 \EndIf
		 \end{algorithmic}
	\end{block}
	Now, let's \textbf{unfold} $gg-copy$ line number $5$. The \textbf{unfold} expression is the definition of $g-copy$ itself
		\begin{algorithmic}[1]
			\tiny
				\If {$isEmpty(p)$}
					\State \Return{$t$}
				\Else
					\If {$isEmpty(top(p)_1)$}
						\If {$isNull(t)$}
							\State \Return{\Call{g-copy}{$tree(root(top(p)_0), top(p)_2),pop(p)$}}
						\Else
							\State \Return{\Call{g-copy}{$tree(root(top(p)_0),top(p)_2 + t),pop(p)$}}
						\EndIf
					\Else
						\State \Return{\Call{g-copy}{\Call{copy}{$first(top(p)_1)$}$, push(<top(p)_0, tail(top(p)_1), top(p)_2 + t>,pop(p))$}}
					\EndIf
				\EndIf
		\end{algorithmic}
\end{frame}
\begin{frame}
	\frametitle{Copy N Ary Tree}
	Now, we will fold it. For lines $6$ and $8$, we will use $gg-copy$ line $5$, and for line $11$ we will use $gg-copy$ line $3$
		\begin{algorithmic}[1]
			\tiny
				\If {$isEmpty(p)$}
					\State \Return{$t$}
				\Else
					\If {$isEmpty(top(p)_1)$}
						\If {$isNull(t)$}
							\State \Return{\Call{gg-copy}{$null,tree(root(top(p)_0), top(p)_2),true,pop(p)$}}
						\Else
							\State \Return{\Call{g-copy}{$null,tree(root(top(p)_0),top(p)_2 + t),true, pop(p)$}}
						\EndIf
					\Else
						\State \Return{\Call{gg-copy}{$first(top(p)_1), null, false, push(<top(p)_0, tail(top(p)_1), top(p)_2 + t>,pop(p))$}}
					\EndIf
				\EndIf
		\end{algorithmic}
\end{frame}
\begin{frame}
	\frametitle{Copy N Ary Tree}
	Now, we have a $gg-copy$ \textit{tail recursive}
	\begin{block}{gg-Copy tail recursive}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{gg-copy}{$a,t,valid,p$}
				\If {$\neg valid$}
...
\begin{frame}
	\frametitle{Copy N Ary Tree}
	\begin{block}{Iterative gg-copy}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{iterative-gg-copy}{$a,t,valid,p$}
				\While{$\neg valid$ $or$ $\neg isEmpty(p)$ }
					\If {$\neg valid$}
				 		\If {$isEmpty(children(a))$}	
							\State $<a,t,valid,p> \gets <null,null,true, push(<a, [],[]>,p)>$
						 \Else
						 	\State $<a,t,valid,p> \gets <first(children(a)),t,false, push(<a,tail(children(a)),[]>,p)>$
						 \EndIf				
					\Else
						\If {$isEmpty(top(p)_1)$}
							\If {$isNull(t)$}
								\State $<a,t,valid,p> \gets <null,tree(root(top(p)_0), top(p)_2),true,pop(p)>$
							\Else
								\State $<a,t,valid,p> \gets <null,tree(root(top(p)_0),top(p)_2 + t),true,pop(p)>$
							\EndIf
						\Else
							\State $<a,t,valid,p> \gets <first(top(p)_1), null, false,push(<top(p)_0, tail(top(p)_1), top(p)_2 + t>,pop(p))>$
						\EndIf
					\EndIf
				\EndWhile
				\State \Return{$t$}
...
\begin{frame}
	...
	\begin{block}{Iterative Copy}
		\begin{algorithmic}[1]
			\Procedure{iterative-copy}{$a$}
				\State \Return{\Call{iterative-gg-copy}{$a,null,false, []$}}
			\EndProcedure
		\end{algorithmic}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Printing Permutations of an array}
		\tiny
		\begin{algorithmic}[1]
			 \Procedure{permutations}{$a,i,n$}
			 	\If {$i \geq n$}
					\State \Return {$[a]$}
				\Else
					\State \Return {\Call{permute}{$a,i,i,n$}}
				\EndIf
			 \EndProcedure
		\end{algorithmic}
	\end{block}
	\begin{block}{Permute}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{permute}{$a,i,j,n$}
				\If {$j \geq n$}
					\State \Return{$[]$}
				\Else
					\State \Return{\Call{permutations}{$swap(a,i,j), i+1,n$} $+$\Call{permute}{$a,i,j+1,n$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
...
\begin{frame}
	...
	\begin{block}{g-permutations}
		\begin{algorithmic}[1]
			\Procedure{g-permutations}{$a,i,n,s$}
				\State \Return{ $s + $ \Call{permutations}{$a,i,n$}}
			\EndProcedure
		\end{algorithmic}
	\end{block}
	\begin{block}{g-permute}
		\begin{algorithmic}[1]
			\Procedure{g-permute}{$a,i,j,n,s$}
				\State \Return {$s +$ \Call{permute}{$a,i,j,n$}}
			\EndProcedure
		\end{algorithmic}
	\end{block}
\end{frame}
		...
		\begin{algorithmic}[1]
			\Procedure{g-permutations}{$a,i,n,s$}
				\If {$ i \geq n$}
					\State \Return {$s+ [a]$}
				\Else
					\State \Return {$s + $ \Call{permute}{$a,i,i,n$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
		...
		\begin{algorithmic}[1]
			\Procedure{g-permutations}{$a,i,n,s$}
				\If {$ i \geq n$}
					\State \Return {$s+ [a]$}
				\Else
					\State \Return { \Call{g-permute}{$a,i,i,n,s$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
...
\begin{frame}
		...
		\begin{algorithmic}[1]
			\Procedure{g-permute}{$a,i,j,n,s$}
				\If {$ j \geq n$}
					\State \Return {$s + []$}					
				\Else
					\State \Return {$s + $ \Call{permutations}{$swap(a,i,j),i+1,n$} + \Call{permute}{$a,i,j+1,n$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
	...
	\begin{algorithmic}[1]
		\tiny
		\State \Return {\Call{g-permutations}{$swap(a,i,j),i+1,n,s$} $+$ \Call{permute}{$a,i,j+1$}}
	\end{algorithmic}
	Now, let's \textbf{unfold} $g-permutations$ in the new line
	\begin{algorithmic}[1]
		\tiny
		\If { $i+1 \geq n$}
			\State \Return {$s + [swap(a,i,j)] + $ \Call{permute}{$a,i,j+1,n$}}
		\Else
			\State \Return {\Call{g-permute}{$swap(a,i,j),i+1,i+1,n,s$} $+$ \Call{permute}{$a,i,j+1,n$}}
		\EndIf
	\end{algorithmic}
\end{frame}
\begin{frame}
	\frametitle{Permutations of an array}
	Let's \textbf{fold} everything
	\begin{algorithmic}[1]
		\tiny
		\If { $i+1 \geq n$}
			\State \Return { \Call{g-permute}{$a,i,j+1,n,s + [swap(a,i,j)]$}}
		\Else
			\State \Return {\Call{g-permute}{$a,i,j+1,n,$\Call{g-permute}{$swap(a,i,j),i+1,i+1,n,s$}}}
		\EndIf
	\end{algorithmic}
	\begin{block}{Folding permute}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{g-permute}{$a,i,j,n,s$}
				\If {$ j \geq n$}
...
\begin{frame}
	\frametitle{Permutations of an array}
	We now have a \textit{Nested} version of $g-copy$. Let's convert it into a \textit{tail} version
	\begin{block}{tail recursive gg-permute}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{gg-permute}{$s,n,p$}
				\If {$isEmpty(p)$}
					\State \Return {$s$}
				\Else
					\State \Return {\Call{gg-permute}{\Call{g-permute}{$top(p)_0,top(p_1),top(p)_2,n,s$}$,n,pop(p)$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
	Let's \textbf{unfold} $g-permute$ in line number $5$ 
	\begin{algorithmic}[1]
		\tiny
		\If {$top(p)_2 \geq n$}
			\State \Return {\Call{gg-permute}{$s+[]$,n,pop(p)}}
		\Else
			\If {$top(p)_1 + 1 \geq n$}
				\State \Return{\Call{gg-permute}{\Call{g-permute}{$top(p)_0, top(p)_1, top(p)_2+1,n, s+ [swap(top(p)_0,top(p)_1,top(p)_2)]  $}$,n,pop(p)$}}
			\Else
				\State \Return {\Call{gg-permute}{\Call{g-permute}{$top(p)_0,top(p)_1,top(p)_2+1,n$,\Call{g-permute}{$swap(top(p)_0,top(p)_1,top(p)_2), top(p)_1+1,top(p)_1+1,n,s$}}$,n,pop(p)$}}
			\EndIf
		\EndIf
	\end{algorithmic}
\end{frame}
\begin{frame}
	\frametitle{Permutations of an array}
	Let's \textbf{fold} line number $5$ by using $gg-permute$ line $5$ definition
	\begin{algorithmic}[1]
		\tiny
		\State \Return {\Call{gg-permute}{$s + [swap(top(p)_0,top(p)_1,top(p)_2)],n,push(<top(p)_0,top(p)_1,top(p)_2+1>,pop(p))$}}
	\end{algorithmic}
	Line number $7$ is \textbf{folded} in two steps in the same way.
	\begin{algorithmic}[1]
		\tiny
		\State \Return {\Call{gg-permute}{\Call{g-permute}{$swap(top(p)_0,top(p)_1,top(p)_2),top(p)_1+1,top(p)_1+1,n,s$}$, n, push(<top(p)_0,top(p)_1,top(p)_2+1>,pop(p))$}}
	\end{algorithmic}
	An the second step
	\begin{algorithmic}[1]
		\tiny
		\State \Return{\Call{gg-permute}{$s,n, push(<swap(top(p)_0,top(p)_1,top(p)_2), top(p)_1+1,top(p)_1+1>,push(<top(p)_0,top(p)_1,top(p)_2+1>,pop(p)))$}}
	\end{algorithmic}
\end{frame}
\begin{frame}
	\frametitle{Permutations of an array}
	\begin{block}{gg-permute}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{gg-permute}{$s,n,p$}
				\If {$isEmpty(p)$}
...
\end{frame}
\begin{frame}
	\frametitle{Permutatons of an array}
	\begin{block}{Iterative - gg-permute}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{iterative-gg-permute}{$s,n,p$}
				\While {$\neg isEmpty(p)$}
					\State $t \gets top(p)$
					\State $p \gets pop(p)$
					\If {$t_2 < n$}
						\If {$t_1 +1 \geq n$}
							\State $s \gets s + [swap(t_0,t_1,t_2)]$
							\State $p \gets push(<t_0,t_1,t_2+1>,p)$
						\Else
							\State $p \gets push(<t_0,t_1,t_2+1>,p)$
							\State $p \gets push(<swap(t_0,t_1,t_2), t_1+1,t_1+1>,p)$
						\EndIf
					\EndIf
				\EndWhile
				\State \Return{$s$}
		...
		\begin{algorithmic}[1]
			\Procedure{g-permutations}{$a,i,n,s$}
				\If {$ i \geq n$}
					\State \Return {$s+ [a]$}
				\Else
					\State \Return { \Call{gg-permute}{$s,n,push(<a,i,i,>, [])$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
...
\begin{frame}
	...
	\begin{block}{Iteratve gg-permutations}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{iterative-gg-permutations}{$a,i,n,s$}
				\If {$ i \geq n$}
					\State \Return {$s + [a]$}
				\Else
					\State \Return {\Call{iterative-gg-permute}{$s,n, push(<a,i,i>,[])$}}
				\EndIf
			\EndProcedure
		\end{algorithmic}
	\end{block}
	\begin{block}{Iterative permutations}
		\tiny
		\begin{algorithmic}[1]
			\Procedure{iterative-permutations}{$a,i,n$}
				\State \Return {\Call{iterative-gg-permutations}{$a,i,n,[]$}}
			\EndProcedure
		\end{algorithmic}
	\end{block}
\end{frame}
